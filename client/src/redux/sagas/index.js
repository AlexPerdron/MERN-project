...
function* fetchPostSaga(action) {
	try {
		const posts = yield call(postAPIs.fetchPosts);
...
function* createPostSaga(action) {
	try {
		...
		const posts = yield call(postAPIs.createPosts, action.payload);
...
function* updatePostSaga(action) {
	try {
		...
		const updatePosts = yield call(postAPIs.updatePosts, action.payload);
